...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s umrcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  umrcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded umrcoin transaction") + "\n" +
              "  umrcoin-tx [options] -create [commands]   " + _("Create hex-encoded umrcoin transaction") + "\n" +
              "\n";

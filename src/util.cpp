...
const char * const BITCOIN_CONF_FILENAME = "umrcoin.conf";
const char * const BITCOIN_PID_FILENAME = "umrcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "UMRcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/UMRcoin";
#else
    // Unix
    return pathRet / ".umrcoin";
#endif
#endif
}
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Bitcoin Core") == std::string::npos) {
        ...
        strCopyrightHolders += "\n" + strYear + "Monacoin Core Developers";

...
space *do not upload these to the umaru-coin.com server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the umaru-coin.com server.

```

- Update umaru-coin.com version

- Announce the release:

  - umrcoin-qtdev and umrcoin-qtdev mailing list

  - blog.umaru-coin.com blog post
